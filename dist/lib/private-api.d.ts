...
import { GetAssetsResponse, gmoResponse, GetMarginResponse, OpenPositionsResponse, PositionSummaryResponse, GetTradingVolumeResponse, gmoExecutionResponseList, OrdersResponse } from './responseType';
...
export declare class gmoPrivateApiClass extends baseApiClass {
    ...
    getOrders(orderIds: string[]): Promise<gmoResponse<OrdersResponse>>;
